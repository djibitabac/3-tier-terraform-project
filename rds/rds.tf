...
resource "aws_db_subnet_group" "apci_jupiter_db_subnet_group" {
  ...
  subnet_ids = [var.db_subnet_az_1a, var.db_subnet_az_1c]
...
resource "aws_vpc_security_group_ingress_rule" "allow_db_traffric" {
...
# Referering an existing password from secret manager--------------------------------------------------------------
